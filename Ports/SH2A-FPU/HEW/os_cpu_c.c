...
OS_STK *OSTaskStkInit (void (*task)(void *pd), void *pdata, OS_STK *ptos, INT16U opt)
{
    ...
    *--stk = 0xA0L;                             /* macl                         */
    *--stk = 0xA1L;                             /* mach                         */
    *--stk = (INT32U)get_tbr();                 /* TBR                          */
    *--stk = (INT32U)OS_Get_GBR();              /* GBR                          */
    *--stk = 0xFL;                              /* FPUL                         */
    *--stk = (INT32U)get_fpscr();               /* FPSCR                        */
    *--stk = 0xF15L;                            /* FR15                         */
    *--stk = 0xF14L;                            /* FR14                         */
    *--stk = 0xF13L;                            /* FR13                         */
    *--stk = 0xF12L;                            /* FR12                         */
...
*                                           TASK RETURN HOOK
*
* Description: This function is called when a task returns.
*
* Arguments  : ptcb    is a pointer to the TCB of the task that returned.
*
* Note(s)    : 1) Interrupts may or may not be ENABLED during this call.
*********************************************************************************************************
*/
