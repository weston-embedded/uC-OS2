...
#if OS_TMR_EN > 0
OS_COMPILER_OPT  INT16U  const  OSTmrTblSize       = sizeof(OSTmrTbl);           /* Size in Bytes of OSTmrTbl[]         */
OS_COMPILER_OPT  INT16U  const  OSTmrWheelTblSize  = sizeof(OSTmrWheelTbl);      /* Size in Bytes of OSTmrWheelTbl[]    */
#endif
