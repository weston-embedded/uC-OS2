...
*
*              (2) IMPORTANT: Currently, the ICC compiler handled function pointers as 16-bit addresses
*                             and thus, we 'force' 0x00 as the upper 8 bits of the task start address
*                             until ImageCraft fixes that issue.
*
*              (3) IMPORTANT: You MUST set OSTaskStkSize and OSTaskStkSizeHard BEFORE calling OSInit()
...
OS_STK  *OSTaskStkInit (void (*task)(void *pd), void *p_arg, OS_STK *ptos, INT16U opt)
{
    ...
    tmp          = *(INT32U const *)task;   /* ICC compiler handles function pointers indirectly!       */
    ...
    *psoft_stk-- = (INT8U)0x31;             /* R31   = 0x31                                             */
    ...
    tmp          = (INT32U)phard_stk;
    tmp        >>= 8;
    *psoft_stk-- = (INT8U)(tmp >> 8);       /* RAMPZ = Upper 8 bits of stack pointer                    */
    *psoft_stk-- = (INT8U)(tmp >> 8);       /* EIND  = Upper 8 bits of stack pointer                    */
