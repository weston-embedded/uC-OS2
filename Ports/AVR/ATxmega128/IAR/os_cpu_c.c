...
*              stack.
*
*              Depending on "Register Utilization" settings, R4 to R15 may be locked to be used for global
*              variables. Thus, their initial value is set to zero.
**********************************************************************************************************
*/
...
{
    OS_STK  *psoft_stk;
    OS_STK  *phard_stk;                      /* Temp. variable used for setting up AVR hardware stack    */
    INT32U   tmp;
    ...
    *psoft_stk--  = (INT8U)0x00;            /* R4      depending on "Register Utilization" settings,    */
    *psoft_stk--  = (INT8U)0x00;            /* R5      R4 to R15 may be locked to be used for global    */
    *psoft_stk--  = (INT8U)0x00;            /* R6      variables                                        */
    *psoft_stk--  = (INT8U)0x00;            /* R7                                                       */
    *psoft_stk--  = (INT8U)0x00;            /* R8                                                       */
    *psoft_stk--  = (INT8U)0x00;            /* R9                                                       */
    *psoft_stk--  = (INT8U)0x00;            /* R10                                                      */
    *psoft_stk--  = (INT8U)0x00;            /* R11                                                      */
    *psoft_stk--  = (INT8U)0x00;            /* R12                                                      */
    *psoft_stk--  = (INT8U)0x00;            /* R13                                                      */
    *psoft_stk--  = (INT8U)0x00;            /* R14                                                      */
    *psoft_stk--  = (INT8U)0x00;            /* R15                                                      */
    tmp           = (INT16U)p_arg;
    ...
    *psoft_stk--  = (INT8U)0x00;            /* RAMPD = 0x00                                             */
    *psoft_stk--  = (INT8U)0x00;            /* RAMPX = 0x00                                             */
    *psoft_stk--  = (INT8U)0x00;            /* RAMPZ = 0x00                                             */
    *psoft_stk--  = (INT8U)0x00;            /* EIND  = 0x00                                             */
