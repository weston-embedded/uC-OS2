...
#define OS_ENTER_CRITICAL() IPL =  7;                            /* Disable all interrupts                         */
#define OS_EXIT_CRITICAL()  IPL =  0;                            /* Eenable interrupts                             */
#endif

#if OS_CRITICAL_METHOD == 3                                      /* Support critical method type 3                 */
#define OS_ENTER_CRITICAL() {cpu_sr = SR; IPL = 7;}              /* Disable all interrupts                         */
