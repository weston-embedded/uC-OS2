...
/* Disable interrupts                                   */
#define  OS_ENTER_CRITICAL()    __asm("DI");
/* Enable interrupts                                    */
#define  OS_EXIT_CRITICAL()     __asm("EI");

#endif

#if      OS_CRITICAL_METHOD == 2
/* Disable interrupts Save Intr. State to Status Reg    */
#define  OS_ENTER_CRITICAL()    __asm("PUSH PSW");                  \
                                __asm("DI");

/* Enable interrupts Recall Intr. State from Status Reg */
...
#define  OS_STK_GROWTH      1                                   /* Stack grows from HIGH to LOW memory on the RL78      */

#define  OS_TASK_SW()       __asm("BRK")                        /* Issues a break instruction                           */
