...
*                 value.
*              7) Take the default values of GPAGE, EPAGE and RPAGE out of your registers.
*********************************************************************************************************
*/
...
OS_STK *OSTaskStkInit (void (*task)(void *pd), void *pdata, OS_STK *ptos, INT16U opt)
{
    ...
    *--wstk = (INT16U)pdata;                /* Simulate call to NON-BANKED function with argument      */
    *--wstk = (INT16U)task;
    ...
    *--wstk = (INT16U)0x0080;               /* CCR Register (Disable STOP instruction) I-Level = 0; User Mode */
    bstk    = (INT8U *)wstk;                /* Convert WORD ptr to BYTE ptr to set CCR                 */
    *--bstk = *(INT8U *)0x10;               /* Save the GPAGE register (see note 7)                    */
    *--bstk = *(INT8U *)0x17;               /* Save the EPAGE register (see note 7)                    */
    *--bstk = *(INT8U *)0x16;               /* Save the RPAGE register (see note 7)                    */
    *--bstk = *(INT8U *)0x15;               /* Save the PPAGE register (Always page 0, see note 6)     */
