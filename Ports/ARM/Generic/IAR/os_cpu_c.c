...
*                                     INITIALIZE EXCEPTION VECTORS
*
* Description : This function initialize exception vectors to the default handlers at a specific address.
*
* Arguments   : None.
*********************************************************************************************************
*/
...
{
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_UNDEF_INSTR_VECT_ADDR))       =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_UNDEF_INSTR_HANDLER_ADDR))    = (INT32U)OS_CPU_ARM_ExceptUndefInstrHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_SWI_VECT_ADDR))               =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_SWI_HANDLER_ADDR))            = (INT32U)OS_CPU_ARM_ExceptSwiHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_PREFETCH_ABORT_VECT_ADDR))    =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_PREFETCH_ABORT_HANDLER_ADDR)) = (INT32U)OS_CPU_ARM_ExceptPrefetchAbortHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_DATA_ABORT_VECT_ADDR))        =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_DATA_ABORT_HANDLER_ADDR))     = (INT32U)OS_CPU_ARM_ExceptDataAbortHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_ADDR_ABORT_VECT_ADDR))        =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_ADDR_ABORT_HANDLER_ADDR))     = (INT32U)OS_CPU_ARM_ExceptAddrAbortHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_IRQ_VECT_ADDR))               =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_IRQ_HANDLER_ADDR))            = (INT32U)OS_CPU_ARM_ExceptIrqHndlr;

    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_FIQ_VECT_ADDR))               =         OS_CPU_ARM_INSTR_JUMP_TO_HANDLER;
    (*(INT32U *)(addr + OS_CPU_ARM_EXCEPT_FIQ_HANDLER_ADDR))            = (INT32U)OS_CPU_ARM_ExceptFiqHndlr;
}
