...
#pragma  O0                               /* Do not optimize this file.                                                 */

                                          /* The following #define could tell the compiler to 'not' optimize these ...  */
...
OS_COMPILER_OPT  INT32U  const  OSEndiannessTest    = 0x12345678uL;              /* Variable to test CPU endianness     */
