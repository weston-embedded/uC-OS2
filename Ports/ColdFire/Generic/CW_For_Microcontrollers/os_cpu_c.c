...
extern const INT32U far _START_SBSS[];                                  /* Defined in the linker file, far forces abs. addressing   */
...
OS_STK  *OSTaskStkInit (void (*task)(void *pd), void *p_arg, OS_STK *ptos, INT16U opt)
{
    ...
    *--pstk32 = (INT32U)_START_SBSS;                                    /* Register A5, Global mem ptr, linker initialized symbol   */
