...
OS_CPU_EXT  INT8U         OSTickDOSCtr;               /* Ctr to call DOS tick handler every 'n' ticks  */
...
extern      INT8U  const  OSTickDOSCtrReload;         /* Reload value for OSTickDOSCtr when it's 0     */
