...
/*
*********************************************************************************************************
*                                    Get Kernel Awareness IPL boundary
*
* Description: This function returns the configuration value for the boundary between kernel-aware and
*              non-kernel-aware ISRs.
*
* Arguments  : None.
*
* Returns    : The IPL in the lower bits (typically a number between 1 and 15)
*********************************************************************************************************
*/

CPU_INT32U  OS_KA_IPL_BoundaryGet (void)
{
    return (CPU_CFG_KA_IPL_BOUNDARY);
}
